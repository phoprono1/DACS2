...
<table width="100%" border="1" style="border-collapse: collapse;">
	...
	while ($row = mysqli_fetch_array($query_lietke_danhmucbv)) {
		...
		<tr>
			...
			<td>
				<a href="module/quanlydanhmucbaiviet/xuly.php?idbaiviet=<?php echo $row['id_baiviet']?>	">Xóa</a> | <a href="?action=quanlydanhmucbaiviet&query=sua&idbaiviet=<?php echo $row['id_baiviet']?>">Sửa</a> 
			</td>
		</tr>
		<?php
	}
