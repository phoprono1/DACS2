<?php
$sql_sua_bv = "SELECT * FROM tbl_baiviet WHERE id_tenbaiviet = '$_GET[idtenbaiviet]' LIMIT 1";
$query_sua_bv = mysqli_query($mysqli, $sql_sua_bv);	
?>
<p>Sửa bài viết</p>
<table border="1px" width="100%" style="border-collapse: collapse;">
	<form method="POST" action="module/quanlybaiviet/xuly.php?idtenbaiviet=<?php echo $_GET['idtenbaiviet']?>" enctype="multipart/form-data">
		<?php
		while($row = mysqli_fetch_array($query_sua_bv)){
			...
			<tr>
				...
				<td>
					...
					<img width="150px" src="module/quanlybaiviet/uploads/<?php echo $row['hinhanh'] ?>">
				</td>
			</tr>
			<tr>
				<td>Tóm Tắt</td>
